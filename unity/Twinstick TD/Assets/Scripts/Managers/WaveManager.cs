...
public class WaveManager
{
    ...
    public double baseDistancePercentage = 0.1;	// distance to be travlled by the enemies to the base
	...
	public WaveManager(GameObject Enemyprefab1, GameObject Enemyprefab2, GameObject Enemyprefab3, GameObject Enemyprefab4, 
					   Transform enemyspawnpoints, Transform target, GameObject gridprefab) {
